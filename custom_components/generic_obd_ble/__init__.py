"""Custom integration to integrate generic OBD BLE with Home Assistant.

For more details about this integration, please refer to
https://github.com/hamishriley/generic-obd-ble
"""
...
from .coordinator import GenericObdBleDataUpdateCoordinator
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry):
    ...
    api = GenericObdBleApiClient(ble_device)
    coordinator = GenericObdBleDataUpdateCoordinator(
        hass,
        address=address,
        api=api,
    ...
    async def update_options_listener(hass: HomeAssistant | None, entry: ConfigEntry):
        ...
        coordinator.entry_data = entry.data
